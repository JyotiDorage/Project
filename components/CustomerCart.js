          ...
          <table class="table table-success table-hover table-striped">
            <thead>
              <tr class="table-success">
                ...
                <td class="table-danger">Customername</td>
              ...
              {list.map((item) => {
                return (
                  <tr class="table-success" key={item.cartid}>
                    ...
                    <td class="table-success">{item.customerusername}</td>
          ...
          <table class="table table-success table-hover table-striped">
            <thead>
              <tr class="table-success">
                ...
                <td class="table-danger">Price To Pay</td>
                <td class="table-danger">Artist id</td>
              ...
              {confirmedlist.map((item) => {
                return (
                  <tr class="table-success" key={item.oid}>
                    ...
                    <td class="table-success">{item.artistname}</td>
                    <td class="table-success">{item.customer.customerusername}</td>
                    <td></td>
                  </tr>
                );
              })}
